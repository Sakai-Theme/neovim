local hsluv = require "sakai.hsluv"
...
function util.onColorScheme()
  if vim.g.colors_name ~= "sakai" then
    vim.cmd [[autocmd! sakai]]
    vim.cmd [[augroup! sakai]]
  end
end
...
function util.autocmds()
  vim.cmd [[augroup sakai]]
  vim.cmd [[  autocmd!]]
  vim.cmd [[  autocmd ColorScheme * lua require("sakai.util").onColorScheme()]]
  vim.cmd [[augroup end]]
end
